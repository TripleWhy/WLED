  ...
  public:
    ...
    void loop() {
      ...
      switch (index) {
        ...
        case  2: measure(NAMED_FUNCTION(&Benchmark::identityUint16)); break;
        case  3: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::identityF)); break;
        case  4: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&Benchmark::identityF)); break;

        case 10: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::addF)); break;
        case 11: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::subtractF)); break;
        case 12: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::multiplyF)); break;
        case 13: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::divideF)); break;
        // case 14: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::fmaManual)); break;
        // case 15: measure(&Benchmark::benchFloat, NAMED_FUNCTION(&Benchmark::fmaLib)); break;
        // case 16: measure(NAMED_FUNCTION(&Benchmark::addUint8)); break;
        // case 17: measure(NAMED_FUNCTION(&Benchmark::subtractUint8)); break;
        // case 18: measure(NAMED_FUNCTION(&Benchmark::multiplyUint8)); break;
        // case 19: measure(NAMED_FUNCTION(&Benchmark::divideUint8)); break;
        // case 20: measure(NAMED_FUNCTION(&Benchmark::addUint16)); break;
        // case 21: measure(NAMED_FUNCTION(&Benchmark::subtractUint16)); break;
        // case 22: measure(NAMED_FUNCTION(&Benchmark::multiplyUint16)); break;
        // case 23: measure(NAMED_FUNCTION(&Benchmark::divideUint16)); break;
        // case 24: measure(NAMED_FUNCTION(&Benchmark::addUint32)); break;
        // case 25: measure(NAMED_FUNCTION(&Benchmark::subtractUint32)); break;
        // case 26: measure(NAMED_FUNCTION(&Benchmark::multiplyUint32)); break;
        // case 27: measure(NAMED_FUNCTION(&Benchmark::divideUint32)); break;
        // case 28: measure(NAMED_FUNCTION(&Benchmark::addInt)); break;
        // case 29: measure(NAMED_FUNCTION(&Benchmark::subtractInt)); break;
        // case 30: measure(NAMED_FUNCTION(&Benchmark::multiplyInt)); break;
        // case 31: measure(NAMED_FUNCTION(&Benchmark::divideInt)); break;
        // case 32: measure(NAMED_FUNCTION(&Benchmark::addInt64)); break;
        // case 33: measure(NAMED_FUNCTION(&Benchmark::subtractInt64)); break;
        // case 34: measure(NAMED_FUNCTION(&Benchmark::multiplyInt64)); break;
        // case 35: measure(NAMED_FUNCTION(&Benchmark::divideInt64)); break;

        case 40: measure(NAMED_FUNCTION(&::sin8)); break;
        case 41: measure(NAMED_FUNCTION(&::sin8_t)); break;
        case 42: measure(NAMED_FUNCTION(&::sin16)); break;
        case 43: measure(NAMED_FUNCTION(&::sin16_t)); break;
        case 44: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&std::sin)); break;
        case 45: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::sinf)); break;
        case 46: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::sin_t)); break;
        case 47: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::sin_approx)); break;

        case 50: measure(NAMED_FUNCTION(&::cos8)); break;
        case 51: measure(NAMED_FUNCTION(&::cos8_t)); break;
        case 52: measure(NAMED_FUNCTION(&::cos16)); break;
        case 53: measure(NAMED_FUNCTION(&::cos16_t)); break;
        case 54: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&std::cos)); break;
        case 55: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::cosf)); break;
        case 56: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::cos_t)); break;
        case 57: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::cos_approx)); break;

        case 60: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&Benchmark::sin66868438)); break;
        case 61: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&Benchmark::cos28050328<float>)); break;

        case 70: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&std::tan)); break;
        case 71: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::tanf)); break;
        case 72: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::tan_approx)); break;

        case 73: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&std::acos)); break;
        case 74: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::acosf)); break;
        case 75: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::acos_t)); break;

        case 76: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&std::asin)); break;
        case 77: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::asinf)); break;
        case 78: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::asin_t)); break;

        case 79: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&std::atan)); break;
        case 80: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::atanf)); break;
        case 81: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::atan_t<float>)); break;
      //  case 82: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::atan2_t)); break;
      //  case 83: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::floor_t)); break;
      //  case 84: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&::fmod_t)); break;

        // case 00: measure(NAMED_FUNCTION(&Benchmark::color_wheel_original)); break;
        // case 00: measure(NAMED_FUNCTION(&Benchmark::color_wheel_hsv)); break;
