  ...
  public:
    ...
    void loop() {
      ...
      switch (index) {
        ...
        case  5: measure(NAMED_FUNCTION(&::sin16)); break;
        case  6: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&Benchmark::sin66868438)); break;
        case  7: measure(&Benchmark::benchFloatTrig, NAMED_FUNCTION(&Benchmark::cos28050328<float>)); break;
