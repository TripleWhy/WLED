...
public:
  void setup()
  {
    ...
    seg.transitionableParameters.setRawColor(0, ((0 << 24) | ((0 & 0xFF) << 16) | ((0 & 0xFF) << 8) | ((0 & 0xFF))));
    ...
    for (int i = 1; i < 10; i++)
    {
      ...
      seg.transitionableParameters.setRawColor(0, ((0 << 24) | ((0 & 0xFF) << 16) | ((190 & 0xFF) << 8) | ((180 & 0xFF))));
