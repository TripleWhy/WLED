...
//  parameters.speed select faderate
//  parameters.intensity select colour index
...
public:
    ...
    bool nextFrameImpl(TransitionableParameters& parameters, const EffectCoordinate& coordinate) {
        ...
        //uint16_t fadeRate = 2*parameters.speed - parameters.speed*parameters.speed/255;    // Get to 255 as quick as you can.
        unsigned fadeRate = parameters.speed*parameters.speed; // Get to 255 as quick as you can.
